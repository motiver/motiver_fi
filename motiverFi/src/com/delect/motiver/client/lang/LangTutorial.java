...
public interface LangTutorial extends Messages {
  ...
  String Main1();
  @DefaultMessage("In training section there are all the workouts you''ve done. Here you can create your own workout or search workouts made by other users.")
  String Main2();
  ...
  @DefaultMessage("Now we go through features in Training section. Open section by selecting ''Training'' from top menu.")
  String WorkoutCreate1();
  @DefaultMessage("In this view you can see workouts added to each day. From calendar above you can select any day you want.")
  String WorkoutCreate2();
  @DefaultMessage("Under the calendar view there are your workouts. There you can create new and edit existing workouts. Click the header to open the panel.")
  ...
  @DefaultMessage("Now you can edit the workout as you like. Move cursor over the workout/exercise to see different action icons. Look at the next guide for how to add new exercise.")
  ...
  @DefaultMessage("You can also edit sets, reps and weights. Look at the next guide when you''re ready.")
  ...
  @DefaultMessage("Add workout to selected day by clicking the ''Move ...'' button")
